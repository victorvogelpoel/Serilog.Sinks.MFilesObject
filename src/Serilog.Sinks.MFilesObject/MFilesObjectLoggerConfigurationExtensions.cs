...
namespace Serilog
{
    public static class MFilesObjectLoggerConfigurationExtensions
    {
        ...
        public static LoggerConfiguration MFilesLogFile(
            this LoggerSinkConfiguration loggerSinkConfiguration,
            IVault vault,
            string mfilesLogFileNamePrefix          = MFilesObjectLoggingVaultStructure.DefaultMFilesLogFileNamePrefix,
            string mfilesLogFileClassAlias          = MFilesObjectLoggingVaultStructure.DefaultMFilesLogClassAlias,
            LogEventLevel restrictedToMinimumLevel  = LevelAlias.Minimum,
